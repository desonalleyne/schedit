...
if __name__ == '__main__':
    ...
    for job in schedit.get_jobs(active_only=True):
        ...
        scheduler.add_job(worker, 'cron',  day_of_week=days, second='*/10', kwargs=json.loads(str(job)))
        #scheduler.add_job(worker, 'cron',  day_of_week=days, hour=hour, minute=minute, kwargs=json.loads(str(job)))
